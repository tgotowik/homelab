...
- get certificates ```certbot certonly --nginx --cert-name tgotowik.de-0001 -d tgotowik.de -d www.tgotowik.de -d nas.tgotowi
k.de -d bw.tgotowik.de -d photos.tgotowik.de -d jf.tgotowik.de -d ha.tgotowik.de```
